...
function NormalEdit() {
  ...
  // Function to handle the completion of an action in the grid
  function actionComplete(args) {
    if (args.requestType === 'save') {
      // Get the modified record
      const modifiedRecord = args.data;
  ...
  return (<div className='control-pane'>
    <div className='control-section'>
      <div className='col-md-9'>
        <GridComponent dataSource={orderDataSource} ref={grid => gridInstance = grid} toolbar={toolbarOptions} allowPaging={true} editSettings={editSettings} pageSettings={pageSettings} actionBegin={actionBegin.bind(this)} actionComplete={actionComplete.bind(this)}>
          <ColumnsDirective>
